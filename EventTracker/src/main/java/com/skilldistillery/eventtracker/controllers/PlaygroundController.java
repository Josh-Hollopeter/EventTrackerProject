...
public class PlaygroundController {
	...
	public Playground update(@PathVariable Integer pid, @RequestBody Playground playground, HttpServletResponse response) {
	Playground updatedPlayground = playServ.update(pid, playground);
